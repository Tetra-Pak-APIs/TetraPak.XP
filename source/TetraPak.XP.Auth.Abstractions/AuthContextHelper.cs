...
public static class AuthContextHelper
{
    ...
    ///   otherwise <c>null</c>. 
    /// </returns>
    public static string? GetAuthorityUri(this AuthContext authContext) => authContext.getAuthorityInfo()?.AuthorityUri;
    ...
    ///   otherwise <c>null</c>. 
    /// </returns>
    public static string? GetTokenIssuerUri(this AuthContext authContext) => authContext.getAuthorityInfo()?.TokenIssuerUri;
    ...
    ///   otherwise <c>null</c>. 
    /// </returns>
    public static string? GetDeviceCodeIssuerUri(this AuthContext authContext) => authContext.getAuthorityInfo()?.DeviceCodeIssuerUri;
    ...
    ///   otherwise <c>null</c>. 
    /// </returns>
    public static string? GetRedirectUri(this AuthContext authContext) => authContext.getAuthorityInfo()?.RedirectUri;
}