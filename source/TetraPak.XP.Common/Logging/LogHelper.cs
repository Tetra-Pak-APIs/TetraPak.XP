...
namespace TetraPak.XP.Logging
{
    public static partial class LogHelper
    {
        ...
        public static void Trace(this ILog? log, string message, LogMessageId? messageId = null) 
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        /// <seealso cref="Trace(ILog?,string,LogMessageId)"/>
        public static void Trace(this ILog? log, Func<string> messageHandler, LogMessageId? messageId = null)
        {
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Debug(this ILog? log, string message, LogMessageId? messageId = null) 
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Debug(this ILog? log, Func<string> messageHandler, LogMessageId? messageId = null)
        {
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Warning(this ILog? log, string message, LogMessageId? messageId = null) 
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Warning(this ILog? log, Func<string> messageHandler, LogMessageId? messageId = null)
        {
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Information(this ILog? log, string message, LogMessageId? messageId = null) 
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Information(this ILog? log, Func<string> messageHandler, LogMessageId? messageId = null)
        {
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Error(this ILog? log, Exception exception, string? message = null, LogMessageId? messageId = null) 
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Error(this ILog? log, Exception exception, Func<string?> messageHandler, LogMessageId? messageId = null)
        {
        ...
        ///   A unique string value for tracking an event through the log (mainly for diagnostics purposes).
        /// </param>
        public static void Any(this ILog? log, string message, LogMessageId? messageId = null) 
            => log?.Any(message, messageId);
        
        public static void Any(this ILog? log, Func<string> messageHandler, LogMessageId? messageId = null)
        {
            if (log is null || !log.IsEnabled(LogRank.Information))
                return;
