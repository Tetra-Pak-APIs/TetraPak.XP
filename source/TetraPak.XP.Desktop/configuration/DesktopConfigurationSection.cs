...
namespace TetraPak.XP.Desktop
{
    ...
    /// </summary>
    [Serializable]
    [JsonConverter(typeof(DesktopConfigurationSectionJsonConverter))]
    [JsonConvertArbitraryObjects(All = typeof(DesktopConfigurationSection))]
    [DebuggerDisplay("{" + nameof(Path) + "}")]
    public class DesktopConfigurationSection : DynamicEntity, IConfigurationSection, IExtendedConfigurationSection
    {
#if DEBUG
        ...
        ConfigPath buildPath() =>
            ParentConfiguration is not IConfigurationSection parentSection 
        ...
        ILog? getParentLog() =>
            ParentConfiguration is DesktopConfigurationSection desktopConfigurationSection
                ? desktopConfigurationSection.Log
                : null;
        ...
        public override T? GetValue<T>(string key, T? useDefault = default) where T : default
        {
            ...
            if (path.Count != 1)
            {
                ...
                if (obj is DesktopConfigurationSection section)
            ...
            obj = base.GetValue<object>(key, null);
            switch (obj)
            {
                case T t:
                    return t;
        ...
        public override void SetValue<TValue>(string key, TValue? value) where TValue : default
        {
            ...
            // attach or detach a child section ...
            if (value is DesktopConfigurationSection child)
            {
                child.AttachToParent(this, key);
                return;
            }

            if (value is null && TryGetValue(key, out var obj) && obj is DesktopConfigurationSection section)
            {
        ...
        /// </summary>
        public DesktopConfigurationSection()
        {
        }
