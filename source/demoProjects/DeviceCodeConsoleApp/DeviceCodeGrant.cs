...
namespace DeviceCodeConsoleApp
{
    ...
    {
        internal static Task<Outcome<Grant>> AcquireDeviceCodeTokenAsync(this string[] args,
            ...
            Action<VerificationArgs> verificationUriHandler)
        {
            ...
            var options =
                GrantOptions.Default(); // <-- use GrantOptions.Forced() to force a new (not cached/refreshed) grant
            ...
            Action<VerificationArgs> verificationUriHandler)
        {
            ...
            var options = GrantOptions
                .Default() // <-- use GrantOptions.Forced() to force a new (not cached/refreshed) grant
